...
public class JquerySortablePage extends BasePage {
    ...
    private static final String HTTPS_JQUERY_SORTABLE_PAGE_URL = "testdata.https.jqueryui.sortable.page.url";
    private static final String HTTP_JQUERY_SORTABLE_PAGE_URL = "testdata.http.jqueryui.sortable.page.url";
